...
package org.jraf.k2o.projects.roundhook
...
@Composable
private fun RoundHook() {
  val lengthX = 25.mm
  val thickness = 3.mm

  val middlePartZLength = 20.mm
  val hookRadius = 22.4.mm / 2 + thickness
...
fun main() {
  openScad(
    SystemFileSystem.sink(Path(TMP_FOLDER, "round-hook.scad")).buffered(),
    fa = .1,
    fs = .1,
  ) {
    RoundHook()
