...
private fun Main(boxSize: BoxSize) {
  ...
  val marginDueToRoundingRadius = interiorRoundingRadius - interiorRoundingRadius * cos(45)
...
private fun TissueBox(
  exteriorSizeX: Double,
  wallThickness: Double,
  exteriorSizeY: Double,
  exteriorSizeZ: Double,
  exteriorRoundingRadius: Double,
  interiorRoundingRadius: Double,
  slideIndentSize: Double,
  marginForSlidingBottom: Double,
  slidingBottomRadius: Double,
  holeSizeX: Double,
  holeSizeY: Double,
) {
...
private fun SlidingBottomPart(
  ...
  marginForSlidingBottom: Double,
  boxSizeX: Double,
  marginDueToRoundingRadius: Double,
  boxSizeY: Double,
  slidingBottomRadius: Double,
) {
  val someMargin = 2.mm
...
@Composable
private fun Hole(x: Double, y: Double, z: Double) {
