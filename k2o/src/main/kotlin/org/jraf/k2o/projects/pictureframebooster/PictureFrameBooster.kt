...
package org.jraf.k2o.projects.pictureframebooster
...
@Composable
private fun PictureFrameBooster() {
...
fun main() {
  openScad(
    SystemFileSystem.sink(Path(TMP_FOLDER, "picture-frame-booster.scad")).buffered(),
  ) {
    PictureFrameBooster()
  }
}
