...
package org.jraf.k2o.projects.shelf
...
@Composable
private fun Reinforcement(reinforcementThickness: Length, reinforcementRadius: Length) {
  translate(x = reinforcementThickness) {
    rotate(y = 90.deg, x = 180.deg) {
...
private fun Guardrail(
  ...
  deckLenY: Length,
  deckLenZ: Length,
  roundedCornerRadius: Length,
  guardrailLenZ: Length,
  guardrailThickness: Length,
  backPylonThickness: Length,
) {
  ...
  translate(
    x = roundedCornerRadius - roundedCornerRadius * cos(45.deg) + guardrailThickness / 2 * cos(45.deg),
    y = roundedCornerRadius - roundedCornerRadius * cos(45.deg) + guardrailThickness / 2 * cos(45.deg),
  ) {
  ...
  translate(
    x = deckLenX - roundedCornerRadius + roundedCornerRadius * cos(45.deg) - guardrailThickness / 2 * cos(45.deg),
    y = roundedCornerRadius - roundedCornerRadius * cos(45.deg) + guardrailThickness / 2 * cos(45.deg),
  ) {
    RoundPylon(guardrailThickness = guardrailThickness, deckLenZ = deckLenZ, guardrailLenZ = guardrailLenZ)
  }
...
@Composable
private fun RoundPylon(guardrailThickness: Length, deckLenZ: Length, guardrailLenZ: Length) {
  translate(
    z = deckLenZ,
  ) {
    Cylinder(
...
@Composable
private fun SquarePylon(guardrailThickness: Length, deckLenZ: Length, guardrailLenZ: Length, backPylonThickness: Length) {
  translate(
    z = deckLenZ,
  ) {
    Cube(
...
//    fs = 0.5,
    sink =
      SystemFileSystem.sink(Path(TMP_FOLDER, "shelf.scad")).buffered(),
  ) {
    Shelf()
  }
}
